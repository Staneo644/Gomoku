...
pub fn main() {
    ...
    let _ = test.set_and_check(3, 5, NonEmptyCell::White);
    let _ = test.set_and_check(3, 4, NonEmptyCell::White);
    let _ = test.set_and_check(4, 2, NonEmptyCell::White);
    let _ = test.set_and_check(5, 2, NonEmptyCell::White);
    let _ = test.set_and_check(3, 2, NonEmptyCell::White);
