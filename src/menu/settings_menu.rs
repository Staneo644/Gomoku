...
impl SettingsMenu {
    pub fn new() -> Self {
       let mut menu = Self {
			input: String::new(),
			buttons: ButtonsHolder {buttons: Vec::new()},
		...
		menu.buttons.buttons.push(Box::new(MenuOption::new(
			...
			(
				Vec2::new(500. - OPTION_WIDTH / 2. as f32, 
    ...
    pub fn draw(&self) {
        ...
        let text_dimensions = measure_text("RESOLUTION", None, scale_to_resolution(40., false) as u16, 0.8);
